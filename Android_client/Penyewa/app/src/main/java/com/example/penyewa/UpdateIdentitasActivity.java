...
public class UpdateIdentitasActivity extends AppCompatActivity {
                ...
                callUpdate.enqueue(new Callback<GetIdentitas>() {
                    ...
                    public void onResponse(Call<GetIdentitas> call, Response<GetIdentitas> response) {
                        if (response.body().getStatus().equals("failed")){
                            Toast.makeText(UpdateIdentitasActivity.this, "Gagal Edit Identitas", Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(UpdateIdentitasActivity.this, "Berhasil", Toast.LENGTH_SHORT).show();
                            Intent myIdentitasIntent = new Intent(getApplicationContext(),LayarIdentitasActivity.class);
                    ...
                    public void onFailure(Call<GetIdentitas> call, Throwable t) {
                        Toast.makeText(UpdateIdentitasActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();

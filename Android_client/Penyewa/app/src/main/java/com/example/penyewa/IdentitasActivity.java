            ...
            public void onClick(View view) {
                ...
                RequestBody reqaction =
                        MultipartBody.create(MediaType.parse("multipart/form-data"),
                                "insert");
//                Call<GetIdentitas> mIdentitas = mAPIInterface.postIdentitas(body, reqid_user,reqaction);
                ...
                identitasCall.enqueue(new Callback<GetIdentitas>() {
                    ...
                    public void onResponse(Call<GetIdentitas> call, Response<GetIdentitas> response) {
                        if (response.body().getStatus().equals("failed")) {
                            ...
                            Toast.makeText(IdentitasActivity.this, "Berhasil", Toast.LENGTH_SHORT).show();
                            openIdentitas();
                        }
    ...
    private void tampilkanSettingsDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(IdentitasActivity.this);
    ...
    {
        Intent intent = new Intent(this.getApplicationContext(), LayarIdentitasActivity.class);

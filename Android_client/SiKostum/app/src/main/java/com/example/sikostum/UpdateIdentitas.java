...
public class UpdateIdentitas extends AppCompatActivity {
    TextView tvStatusId,tvId;
    ImageView ivPhoto;
    Button btCameraId, btSimpanUp, btKembaliUp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btKembaliUp = (Button) findViewById(R.id.btKembaliUp);
        ivPhoto = (ImageView) findViewById(R.id.ivPhoto);

        final Intent mIntent = getIntent();
       tvId.setText(mIntent.getStringExtra("id_identitas"));
//        id_identitas = mIntent.getStringExtra("id_identitas");
                ...
                callUpdate.enqueue(new Callback<GetIdentitas>() {
                    ...
                    public void onResponse(Call<GetIdentitas> call, Response<GetIdentitas> response) {
                        if (response.body().getStatus().equals("failed")){
                            Toast.makeText(UpdateIdentitas.this, "Gagal Edit Identitas", Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(UpdateIdentitas.this, "Berhasil", Toast.LENGTH_SHORT).show();
                            Intent myIdentitasIntent = new Intent(getApplicationContext(),LayarIdentitas.class);
                    ...
                    public void onFailure(Call<GetIdentitas> call, Throwable t) {
                        Toast.makeText(UpdateIdentitas.this, t.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        btKembaliUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIdentitasIntent = new Intent(getApplicationContext(), LayarIdentitas.class);
                startActivity(myIdentitasIntent);
